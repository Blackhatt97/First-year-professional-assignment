...
public class DBConn {
    ...
    public void updateUser(int id, String fname, String lname, String email,
                                String type, String address, Date date_birth) {
    ...
    public void addUserToDB(String f_name, String l_name, Date date_birth, String email, String address, String type_user, String pass) {
